...
def refreshCallback(guild_id: int, channel_id: int)->str:
    pass


class PersistantMessage:
    def __init__(self, bot: commands.Bot, guild_id, channel_id, default_message: str, refresh_callback=None, refresh_interval: int=None, persist_interval=60):
        self.bot = bot
    ...
    async def send_message(self):
        channel = self.bot.get_channel(self.channel_id)
        await channel.send(content=self.message_content)
